...
export default function Register({ onSignUp }) {
	...
	return (
		<div className="auth">
			<form name="register" className="form" noValidate onSubmit={handleSubmit}>
				...
				<button className="form__save-btn form__save-btn_light" type="submit">
					Зарегистрироваться
				</button>
				<p className="form__link" onClick={handleClickLink}>
